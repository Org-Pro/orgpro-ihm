...
public enum Message {
    ...
    COLLABORATEUR_AJOUT_DOSSIER_GOOGLE_SUCCES(COULEUR_SUCCES + "SUCCESS : Collaborator directory for google connection created"),
    ...
    COLLABORATEUR_AJOUT_DOSSIER_GOOGLE_ALREADY_EXIST(COULEUR_SUCCES + "INFO : Collaborator directory for google already exist therefore was not created"),
    COLLABORATEUR_DOSSIER_EXISTE_DEJA_ECHEC(COULEUR_ECHEC + "FAILURE : The directory already exist"),
