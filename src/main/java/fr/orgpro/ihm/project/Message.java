...
public enum Message {
    ...
    COLLABORATEUR_AVEC_TRELLO_BOARD(COULEUR_SUCCES+ "INFO : Collaborateur already have trelloboard" + COULEUR_RESET),
    COLLABORATEUR_SANS_TRELLO_LIST(COULEUR_ECHEC + "INFO : Collaborator without trelloList" + COULEUR_RESET),
    COLLABORATEUR_AVEC_TRELLO_LIST(COULEUR_SUCCES+ "INFO : Collaborateur already have trellolist" + COULEUR_RESET),
